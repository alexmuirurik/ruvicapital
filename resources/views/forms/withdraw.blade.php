<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
    ...
    <div class="offcanvas-body">
        <form method="post" action="{{route('withdraw.store')}}" id="creatingadeposit">
            @csrf
            <div class="form-group mb-3">
                <label for="amount" class="form-label">Amount to Withdraw</label>
                <input type="number" class="form-control" id="amount" name="amount" step="0.10"
                    placeholder="${{$earning?->working_capital ?? '0.00'}}" required="">
            </div>
            <div class="form-group mb-3">
            ...
            <div class="form-group">
                ...
                <div class="btn w-100">
                    <button type="submit" class="btn btn-sm btn-primary m-auto">Make a Withdrawal</button>
                </div>
            </div>
        </form>
    </div>
