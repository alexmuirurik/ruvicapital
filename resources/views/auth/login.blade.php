            ...
            <div class="row">
                <div class="form-responsive sign-in col-12 col-md-6">
                    <form method="post" action="{{route('login')}}">
                        @csrf
                        <h1 class="form-title my-4">Log into Your Account</h1>
                        ...
                        <div class="form-inputs">
                            ...
                            <div class="form-group">
                                <input type="password" name="password" class="form-control" placeholder="Password" required="" value="{{request()->password}}">
                            </div>
                            <div class="form-group d-md-flex justify-content between">
                                <a class="btn btn-neutral btn-sm mb-3" href="{{route('password.request')}}">Forgot Your Password?</a>
                                <button type="submit" class="btn btn-sm btn-primary ms-auto w-25">Log In</button>
                            </div>
                        </div>
                    </form>
                </div>
